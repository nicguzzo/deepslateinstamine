...
public class Config {
    ...
    public String[] pickaxe_instamine_blocks = {
        "minecraft:deepslate",
        "minecraft:cobblestone",
        "minecraft:end_stone",
    };
    public String[] pickaxes_that_can_instamine = {
    ...
    public static void load_config() {
        INSTANCE = new Config();
        Gson gson = new Gson();
        File configFile = new File(configDir,"deepslate_instamine.json");
        ...
        if (INSTANCE != null) {
                    ...
                    if (item != null && item != Items.AIR) {
                        ...
                        if (blk != null) {
                            ...
                            LOGGER.info(
                                "This item: " +
                                    item +
                                    " can't be instamined, not a Block"
                            );
                        }
                    } else {
            ...
            for (String id : INSTANCE.pickaxes_that_can_instamine) {
                ...
                if (res != null) {
                    Item item = get_from_reg(res);
                    if (item != null && item != Items.AIR) {
                        if(DeepslateInstamineMod.is_tool(item)) {
                            ...
                            LOGGER.info(
                                "This item: " +
                                    item +
                                    " can't be used to instamine, not a DiggerItem"
                            );
                        }
                    } else {
                        LOGGER.info("item not found: " + id);
            ...
            for (String id : INSTANCE.axes_that_can_instamine) {
                ...
                if (res != null) {
                    ...
                    if (item != null && item != Items.AIR) {
                        if (
                            DeepslateInstamineMod.is_tool(item)
                        ) {
